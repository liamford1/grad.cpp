...
void test_negative_numbers() {
    ...
    std::cout << "  x = [" << x.getValue(0, 0) << ", " << x.getValue(0, 1) << ", "
              << x.getValue(0, 2) << "]\n";
    std::cout << "  y = [" << y.getValue(0, 0) << ", " << y.getValue(0, 1) << ", "
              << y.getValue(0, 2) << "]\n";
    std::cout << "  Expected: z = [-8.0, 12.0, 1.0]\n";
    std::cout << "  Actual:   z = [" << z.getValue(0, 0) << ", " << z.getValue(0, 1) << ", "
              << z.getValue(0, 2) << "]\n";
...
void test_layernorm_scenario() {
    ...
    std::cout << "  Actual: [" << centered.getValue(0, 0) << ", " << centered.getValue(0, 1) << ", "
              << centered.getValue(0, 2) << ", " << centered.getValue(0, 3) << "]\n";
...
void test_gradient_update_scenario() {
    ...
    std::cout << "  Actual: [" << new_param.getValue(0, 0) << ", " << new_param.getValue(0, 1)
