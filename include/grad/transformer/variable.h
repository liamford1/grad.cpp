...
public:
    ...
    [[nodiscard]] static std::shared_ptr<Variable> create(const Tensor& data,
                                                          bool requires_grad = false);
    [[nodiscard]] static std::shared_ptr<Variable> create(Tensor&& data,
                                                          bool requires_grad = false);
    [[nodiscard]] static std::shared_ptr<Variable> create(size_t rows, size_t cols,
                                                          bool requires_grad = false);
    [[nodiscard]] static std::shared_ptr<Variable> create(size_t batch_size, size_t rows,
                                                          size_t cols, bool requires_grad = false);
...
private:
    void topologicalSort(std::vector<std::shared_ptr<Variable>>& sorted,
